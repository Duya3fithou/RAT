import { Award, BookOpen, Bookmark, Brush, Camera, Code, CuboidIcon, FileText, Grid, Home, ImageIcon, Layers, LayoutGrid, Lightbulb, Palette, Play, Sparkles, TrendingUp, Users, Video, Wand2 } from 'lucide-react'
...
export const apps = [
  ...
  {
    name: "FontForge",
    icon: <Wand2 className="text-amber-500" />, // Replaced Type with Wand2 as Type wasn't in the original import list I copied, checking original file... Type was imported. I'll add it back if I can, or use Wand2 as fallback. Original had Type. I will add Type to imports.
